...
public class QoS4SendDaemonS2C {
    ...
    private static final int MESSAGES_JUST$NOW_TIME = 2000;
    private static final int QOS_TRY_COUNT = 1;
    ...
    private void init() {
        this.timer = new Timer(CHECK_INTERVAL, e -> QoS4SendDaemonS2C.this.run());
    }
    ...
    public QoS4SendDaemonS2C startup(boolean immediately) {
        ...
        if (immediately)
            ...
            this.timer.setInitialDelay(CHECK_INTERVAL);
